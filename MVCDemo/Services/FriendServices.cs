    ...
    public class FriendServices
    {
        ...
        static FriendServices()
        {
            Friends = new List<Friend>
                {
                    new Friend { FriendId = 1, FriendName = "Aadi", Place="Nellore" },
                    new Friend { FriendId = 2, FriendName = "Teja", Place="Andhra" },
                    new Friend {FriendId = 3, FriendName = "Kiran", Place="Chennai" }
                };
        }
